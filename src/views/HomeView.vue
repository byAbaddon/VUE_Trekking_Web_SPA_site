...
<template>
  <div class="home d-md-flex flex-md-equal  my-md-8 pl-md-3">
    <div style=" padding-left: 7%; padding-top:3%;" class="col-md-7">
      <h2 class="featurette-heading">Here you will find the treks you've <span class="text-highlighted">always dreamed
          about!</span></h2>
    ...
    <div class="col-md-5">
      <img class="home-picture" :src="'../src/assets/images/annapurna.jpg'" />
    </div>
  </div>
</template>
